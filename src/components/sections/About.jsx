  ...
  return (
    ...
    >
      ...
      <h2 style={{
        ...
        A little about <span style={{ color: "#00b4d8" }}>me</span>
      </h2>
      ...
      <div style={{
        ...
        <div>
          <p style={{
            ...
            Hey! I am{" "}
            <span style={{ color: "#00b4d8", fontWeight: "500" }}>Radhika</span>
          ...
          <p style={{
            ...
            Also a{" "}
            <span style={{ color: "#00b4d8", fontWeight: "500" }}>ChaiCode Campus Ambassador</span>
